...
function writeHostEntry(environment, packageRoot, targetRoot) {
...
function activateEnvironment(options) {
  ...
  const entry = options.dryRun ? ENVIRONMENTS[environment].entry?.target || null : writeHostEntry(environment, packageRoot, target);
