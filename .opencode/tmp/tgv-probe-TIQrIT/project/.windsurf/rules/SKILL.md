...
description: 从需求文档、PRD、API 规范、源代码、缺陷修复上下文或功能描述中生成结构化、可追溯、可执行的软件测试用例与测试设计产物。当用户提出生成、扩展、评审、标准化、优化或审计测试用例、测试场景、测试点清单、MBT 导向测试设计结果或测试文档时使用。已为 Claude / Qoder / CodeBuddy / Codex / OpenClaw / Trae 提供完整或软适配入口（详见 `HOST_COMPATIBILITY.md`）。
---
