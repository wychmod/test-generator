...
| # | 检查项 | 标准 |
|---|-------|------|
| SC3-1 | 实体完整性 | 所有核心业务概念都已建模为实体 |
| SC3-2 | ERD 一致性 | 图形表示与关系表完全对应 |
| SC3-3 | 状态机完备性 | 每个非终态在每种可能事件下都有明确的目标状态 |
| SC3-4 | 无死状态 | 所有状态都可以从初始状态到达 |
| SC3-5 | 参数空间完整 | 所有输入参数都已定义值域和约束 |
| SC3-6 | 与前阶段一致 | 实体/状态/参数都能追溯到 Phase 1 或 Phase 2 |
